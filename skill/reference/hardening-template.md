...
> **刻意用最简的那份做教学载体**（3 组 / 13 条），把每一段的理由讲透。
...
```
Proxy = smart, "Node-A", "Node-B", icon-url=https://raw.githubusercontent.com/RiverFlowsInUUU/surge-anti-dns-leak/main/icons/Proxy.png
